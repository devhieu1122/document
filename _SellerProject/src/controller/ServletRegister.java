...
public class ServletRegister extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(name.equals("")||username.equals("")||password.equals("")||rpass.equals("")||email.equals("")||phone.equals("")) {
		...
		if(err.length()==0) {
			...
			userDAO._addUser(new User(i++, username, name, MD5_MaHoaPass.maHoaDuLieu(password), birth, gender, email, phone, address, 2));
