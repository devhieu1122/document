       ...
       <jsp:include page="header.jsp"></jsp:include>
		...
		<section class="main-content-section">
			<div class="container">
				...
				<div class="row">
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						<h2 class="page-title">Giao hàng:</h2>
					</div>	
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						...
						<div class="shoping-cart-menu">
							<ul class="step">
								...
								<li class="step-todo third step-done">
									<span><a href="checkout-address.jsp">03. Địa chỉ</a></span>
								</li>
					...
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						...
						<div class="product-delivery-option">
							<div class="product-delivery-address">
								<p>Lựa chọn loại hình giao hàng</p>
							</div>
												...
												<td class="delivery-option-radio">
													<div class="dalivery-radio">
														<span class="radio-box">
															<input type="radio" value="1" name="deliverymethod" checked="checked">
														</span>
													</div>
												</td>											
						...
						<div class="returne-continue-shop">
							...
							<a href="checkout.jsp" class="procedtocheckout">Tiếp tục<i class="fa fa-chevron-right"></i></a>
						</div>	
