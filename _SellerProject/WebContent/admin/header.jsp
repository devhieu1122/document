		...
		<div class="row">
			<div class="col-sm-12">
				...
				<div class="categorys-product-search">
					<form action="ServletSearch?pages=1" method="post" class="search-form-cat">
						<div class="search-product form-group">
							...
							</select>  <input type="text" class="form-control search-form" name="name_search"
	...
	<div class="container">
		<div class="row">
			...
			<div
				...
				<div class="shopping-cart-out pull-right">
					<div class="shopping-cart">
						<a class="shop-link" title="Không có sản phẩm nào trong giỏ hàng"> <i
			...
			<div
				...
				<div class="mainmenu">
					...
					<ul class="list-inline mega-menu">
						<li><a href="index.jsp"  title="Trang chủ">Trang chủ</a> <!-- DROPDOWN MENU START -->
						...
						<%
							...
							%>
						<li><a
							href="category.jsp?id_category=<%=cat.getId_category()%>&pages=1" title="<%=cat.getName_category()%>"><%=cat.getName_category()%></a>
							<!-- DRODOWN-MEGA-MENU START -->
							<div class="drodown-mega-menu">
								<div class="left-mega col-xs-6">
									<div class="mega-menu-list">
										<a class="mega-menu-title" href="">Hãng sản
											xuất</a>
										...
										<ul>
											...
											%>
											<li><a href="" title="<%=producer.getName_producer() %>"><%=producer.getName_producer() %></a></li>
											<%
												}	
											%>
										</ul>
								...
								<div class="right-mega col-xs-6">
									<div class="mega-menu-list">
										<a class="mega-menu-title" href="">Giá</a>
										<ul>
											<li><a href="">Dưới 5 triệu</a></li>
											<li><a href="">Từ 5 đến 10 triệu</a></li>
											<li><a href="">Từ 10 triệu đến 15 triệu</a></li>
											<li><a href="">Từ 15 triệu đến 20 triệu</a></li>
